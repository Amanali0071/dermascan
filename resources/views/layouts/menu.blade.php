...
@role('doctor')
    ...
    <li class="nav-item {{ Request::is('doctors/patient-chat*', 'doctors/patient*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('doctors.patient-chat') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-calendar-alt"></i></span>
            <span class="aside-menu-title">{{('Chat') }}</span>
        </a>
    </li>
    <li class="nav-item {{ Request::is('doctors/patient-chat*', 'doctors/patient*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('patient.reports') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-file"></i></span>
            <span class="aside-menu-title">{{('Patient Reports') }}</span>
        </a>
    </li>
...
@role('patient')
    ...
    <li style="background-color:goldenrod; color: #fff;" class="nav-item">
        <a class="nav-link d-flex align-items-center py-4" aria-current="page"
            href="{{ route('show.payment.form') }}" target="_blank" style="color:#fff;">
            <span class="aside-menu-icon pe-3"><i class="fas fa-money-bill-wave"></i></span>
            <span class="aside-menu-title">{{ __('Become Premium') }}</span>
        </a>
    </li>
    @endif
...
<li class="nav-item {{ Request::is('admin/smart-patient-cards*', 'admin/generate-patient-smart-cards*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-4" aria-current="page" href="{{ route('smart-patient-cards.index') }}">
        <span class="aside-menu-icon pe-3"><i class="fa-solid fa-id-card"></i></span>
        <span class="aside-menu-title">{{ __('messages.smart_patient_card.smart_patient_cards') }}</span>
    </a>
</li>
