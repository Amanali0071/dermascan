...
use App\Http\Controllers\PDChatController;
...
Route::post('/send-message', [PDChatController::class, 'sendMessage']);
Route::middleware('setLanguage')->group(function () {
    Route::get('/', [FrontController::class, 'medical'])->name('medical');
    Route::get('/get-check', [FrontController::class, 'getcheck'])->name('getcheck');
    Route::get('/contact-us', [FrontController::class, 'contactus'])->name('contactus');
    Route::post('/contact-us/store', [FrontController::class, 'contactusStore'])->name('contactus.store');
    Route::get('/about-us', [FrontController::class, 'aboutus'])->name('aboutus');
    Route::get('/pharmacy', [FrontController::class, 'pharmacy'])->name('pharmacy');
    Route::get('/research', [FrontController::class, 'research'])->name('research');
    Route::get('/skinguide', [FrontController::class, 'skinguide'])->name('skinguide');
    Route::get('/sign-up', [FrontController::class, 'signup'])->name('signup');
    Route::get('/doctor-list', [FrontController::class, 'doctorlist'])->name('doctor-list');
    Route::get('/doctor-chat', [FrontController::class, 'chatbox'])->name('chatbox');
    ...
    Route::get('/patient-reports', [ReportController::class, 'patientReports'])->name('patient.reports');
    Route::post('model-data',[ReportController::class,'modelRequest'])->name('model-api');
});
//Change language
...
Route::get('/register-doctor', [RegisteredUserController::class, 'registerdoctor'])->name('registerdoctor');
Route::post('/doctor-store', [RegisteredUserController::class, 'doctorstore'])->name('doctorstore');
...
Route::get('patient-chat',[PDChatController::class,'doctorchatindex'])->name('doctors.patient-chat');
Route::get('/doctor/chat/history/{id}', [PDChatController::class, 'getMessageHistory']);
//\call
...
Route::get('patient-reports', [ReportController::class, 'patientReports'])->name('patient.reports');
Route::get('patient-reports/search', [ReportController::class, 'searchReports'])->name('patient.reports.search');
Route::get('patient-reports/download/{id}', [ReportController::class, 'downloadReport'])->name('patient.reports.download');
...
Route::get('test-search', function() {
    return response()->json([
        ...
        'route' => route('patient.reports.search')
    ]);
});
...
Route::get('/show-payment-form', [PaymentController::class, 'paymentFrom'])->name('show.payment.form');
Route::post('/create-payment-intent', [PaymentController::class, 'createPaymentIntent']);
Route::get('/checkout-pharmacy', [MedicineController::class, 'checkout'])->name('checkoutpharmacy');