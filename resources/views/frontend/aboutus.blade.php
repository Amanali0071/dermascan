...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .team-members, .features, .values {
                grid-template-columns: 1fr;
            }
            
            .team-member, .feature-card, .value-item {
                margin-bottom: 20px;
            }
        }
        .button2{
...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>About Dermascan</h1>
            <p>Leading the Way in Online Dermatology Services</p>
        </div>
    </section>
    ...
    <main>
        <section class="about-us">
            <h2>Our Mission</h2>
            <p>At Dermascan, we believe that everyone deserves access to high-quality dermatological care, regardless of location or schedule. Our platform allows users to submit skin concerns, receive expert analysis, and access personalized treatment recommendations—all from the comfort of their home. We are committed to providing a seamless, secure, and user-friendly experience that prioritizes privacy and trust.</p>
            ...
            <div class="team-members">
                <div class="team-member">
                    ...
                    <p class="bio">With over 15 years of experience, Dr. Doe specializes in skin cancer detection.</p>
                </div>
                <div class="team-member">
                    ...
                    <p class="title">Dermatologist</p>
                    <p class="bio">Dr.Nusrat Ali drives innovation with cutting-edge telemedicine solutions.</p>
                </div>
                <div class="team-member">
                    ...
                    <p class="bio">Dr. White is passionate about accessible skin care for all.</p>
                </div>
            </div>

            <h2>Why Choose Dermascan?</h2>
            <div class="features">
                <div class="feature-card">
                    <i class="fas fa-user-md"></i>
                    <h3>Expertise You Can Trust</h3>
                    <p>Our dermatologists are board-certified with years of experience.</p>
                </div>
                <div class="feature-card">
                    <i class="fas fa-clock"></i>
                    <h3>Convenience</h3>
                    <p>Submit your case anytime and get a report within 24-48 hours.</p>
                </div>
                <div class="feature-card">
                ...
                <div class="feature-card">
                    ...
                    <p>From analysis to treatment, we cover it all.</p>
                </div>
            </div>

            <h2>Our Commitment to Research</h2>
            <p>Dermascan is not just a service; it's a commitment to advancing skin health research. We collaborate with leading research institutions to improve diagnostic accuracy and develop new treatment protocols. Our platform also contributes to a growing database of skin health data, helping to drive innovation in dermatology.</p>
            ...
            <div class="values">
                <div class="value-item">
                    ...
                    <h3>Compassion</h3>
                    <p>We care deeply about your skin health and well-being.</p>
                </div>
                <div class="value-item">
                    <i class="fas fa-lightbulb"></i>
                    <h3>Innovation</h3>
                    <p>We push the boundaries of telemedicine technology.</p>
                </div>
                <div class="value-item">
                    <i class="fas fa-users"></i>
                    <h3>Accessibility</h3>
                    <p>Skin care for everyone, everywhere.</p>
                </div>
            </div>
            ...
            <div class="testimonials">
                <blockquote>
                    <p>"Dermascan helped me identify a skin issue quickly and discreetly. Highly recommend!"</p>
                    <cite>— Aman Ali, Patient</cite>
                </blockquote>
                <blockquote>
                    <p>"The expertise and convenience are unmatched. A game-changer in dermatology."</p>
                    <cite>— Muzammil iqbal., User</cite>
                </blockquote>
            </div>

            <div class="cta">
                <a href="{{route('contactus')}}" class="button">contact us for more information</a>
            </div>
        </section>
    </main>
