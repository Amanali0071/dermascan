...
<body class="bg-gray-100">
    ...
    <main class="min-h-screen flex items-center justify-center py-12">
        <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full fade-in" style="border: 0.5px solid darkgray;">
            <h1 class="text-3xl font-bold text-gray-700 text-center mb-4">Login to Your Account</h1>
            <p class="text-gray-600 text-center mb-6">Access your DermaScan account for expert dermatology
                consultations.</p>

            <!-- Google Login Button -->
            <a href="{{ route('social.login', 'google') }}" class="w-full bg-white border border-gray-300 text-gray-700 p-3 rounded-lg font-semibold hover:bg-gray-100 transition duration-300 mb-4 flex items-center justify-center">
                <i class="fab fa-google mr-2"></i> Login with Google
            </a>

            <!-- Facebook Login Button -->
            <a href="{{ route('social.login', 'facebook') }}" class="w-full bg-blue-400 text-white p-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-300 mb-4 flex items-center justify-center">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <button id="submit-btn" type="submit"
                    class="w-full border-2 border-teal-500 text-teal-500 p-3 rounded-lg font-semibold hover:bg-teal-500 hover:text-black hover:bg-blue-100 transition duration-300">Login</button>
            </form>
            
            <p class="text-center mt-4">Don't have an account? <a href="{{ route('register') }}"
                    class="text-teal-500 hover:text-teal-700">Sign up here</a></p>
        </div>
    </main>
